...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="?action=home">Admin - Mobile Shop</a>
            </div>
            <!-- /.navbar-header -->
                ...
                <div class="sidebar-nav navbar-collapse">
                    ...
                    <li class="sidebar-search text-center" id="admin">
                            <div class="input-group custom-search-form">
                                <img src="../controller/images/logo.jpg" class="img-circle" width="100px" height="100px">
                                <h4 class="text-info bg-info" style="padding:15px; width: 100%;">Admin</h4>
                            </div>
                            <!-- /input-group -->
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="?action=adorder"><i class="fa fa-building-o"></i> Đơn hàng</a>
                        </li>
                        <li>
                            <a href="?action=oderdetail"><i class="fa fa-database" aria-hidden="true"></i> Chi tiết đơn hàng</a>
                        </li>
    ...
    <section id="page-wrapper">
            <div class="row">
                <div class="col-xs-12">
                    <h3 class="alert alert-info" >Chi tiết Đơn hàng</h3>
                </div>
